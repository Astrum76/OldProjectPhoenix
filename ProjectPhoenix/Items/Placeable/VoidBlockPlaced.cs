...
namespace ProjectPhoenix.Items.Placeable
{
	public class VoidBlockPlaced : ModItem
	{
		public override void SetStaticDefaults()
		{
			Tooltip.SetDefault("No, it's not.");
		...
		public override void AddRecipes()
		{
			...
			recipe.AddIngredient(ModContent.ItemType<VoidBlock>());
